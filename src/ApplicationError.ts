...
export class ApplicationError extends Error {
  ...
  public usedMethod: string = "UNKNOWN";
  public usedEndpoint: string = "UNKNOWN";
  ...
  public constructor(options: ApplicationErrorOptions = {}) {
    ...
    super(
      `[E_${ApiErrorCode[apiErrorCode]}]: ${publicMessage} ${
  ...
  public static isApplicationError(ex: unknown): ex is ApplicationError {
    return (
      ex !== null &&
      typeof ex === "object" &&
      (ex as { isApplicationError?: true }).isApplicationError === true
    );
  }

  public static wrap(
    ex: unknown,
    options: Omit<ApplicationErrorOptions, "innerError"> = {}
  ) {
